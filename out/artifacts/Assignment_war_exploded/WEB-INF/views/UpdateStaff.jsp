...
<div class="container">
    ...
    <form:form action="updateStaff" method="post" modelAttribute="staffs" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label>ID</label><br>
                <label>${staffs.id}</label>
                <form:hidden class="form-control" placeholder="Full Name" path="id"/>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <form:input type="text" class="form-control" id="inputEmail4" placeholder="" path="name"/>
            </div>
            <div class="form-group col-md-6">
                <label for="inputEmail4">Birth Day</label>
                <form:input type="text" class="form-control" id="inputEmail4" placeholder="" path="birthday"/>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <form:input type="text" class="form-control" id="inputEmail4" placeholder="" path="salary"/>
            </div>
            <div class="form-group col-md-6">
                <label for="inputEmail4">Level</label>
                <form:input type="text" class="form-control" id="inputEmail4" placeholder="" path="level"/>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-lg-6 col-md-7">
            <img src="${pageContext.servletContext.contextPath}/images/${staffs.photo}" height="50" width="50"><br>
        ...
        <button type="submit" class="btn btn-primary" name="btnUpdate"  style="margin-top: 100px">Update</button>
    </form:form>
