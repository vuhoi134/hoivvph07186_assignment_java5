...
<%--    <form action="updateDepart.htm">--%>
<%--        <button type="button" class="btn btn-outline-warning" id="button1" data-toggle="modal" data-target="#myModal1">Insert</button>--%>
<%--    </form>--%>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Insert Depart</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <%--@elvariable id="depart" type="depart"--%>
                    <form:form action="insertDepart.htm" method="post" modelAttribute="depart">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th style="padding-left: 100px" scope="col">Action</th>
        </tr>
        </thead>
        <tbody id="myTable">
        <c:forEach var="d" items="${depart}">
            <tr>
                <td>${d.id}</td>
                <td type="password">${d.name}</td>


                <td width="250" class="text-right">
                    <a href="update?id=${d.id}">
                        <button class="btn btn-info">Edit</button>
                    </a>
                    <a href="deleteDepart?id=${d.id}">
